  ...
  return (
    <a href="/" className="w-full flex flex-col items-center mb-2">
      <section className="main-logo-area">
        <img src={logo} alt="Logo do hotel" className="size-28 md:size-20" />
      </section>
      <section className="title-area text-center">
        <span className="libre-baskerville-regular text-2xl tracking-wide font-bold color-d">EDEN</span>
        <br />
