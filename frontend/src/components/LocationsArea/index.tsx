  ...
  return (
    <div id="locations-area" className="my-6" >
      <div className="md:w-[70%] mx-auto max-w-[500px]">
        <h2 className="libre-baskerville-regular text-2xl color-a text-center uppercase font-bold">Locais</h2>
      ...
      <div id="locations-container" className="my-5 md:grid md:grid-cols-2 md:max-w-[90%] mx-auto max-w-[600px] lg:max-w-[80%] xl:max-w-[70%]">
        <div className="overlay overflow-hidden">
          <div className="card-img relative">
            <img src={location1} className="h-[20rem] object-cover w-full transition-all ease-in duration-300 hover:scale-110" alt="EDEN Hotel em Paris" />
        ...
        <div className="overlay overflow-hidden">
          <div className="card-img relative">
            <img src={location2} className="h-[20rem] object-cover w-full transition-all ease-in duration-300 hover:scale-110" alt="EDEN Hotel em Paris" />
        ...
        <div className="overlay overflow-hidden">
          <div className="card-img relative">
            <img src={location3} className="h-[20rem] object-cover w-full transition-all ease-in duration-300 hover:scale-110" alt="EDEN Hotel em Paris" />
        ...
        <div className="overlay overflow-hidden">
          <div className="card-img relative">
            <img src={location4} className="h-[20rem] object-cover w-full transition-all ease-in duration-300 hover:scale-110" alt="EDEN Hotel em Paris" />
        ...
        <div className="overlay overflow-hidden">
          <div className="card-img relative">
            <img src={location5} className="h-[20rem] object-cover w-full transition-all ease-in duration-300 hover:scale-110" alt="EDEN Hotel em Paris" />
        ...
        <div className="overlay overflow-hidden">
          <div className="card-img relative">
            <img src={location6} className="h-[20rem] object-cover w-full transition-all ease-in duration-300 hover:scale-110" alt="EDEN Hotel em Paris" />
