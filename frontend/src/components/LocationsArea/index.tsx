...
function LocationsArea() {
  return (
    <div id="locations-area" className="my-6" >
      ...
      <div id="locations-container" className="my-5">
        <div className="card-img relative">
          <img src={location1} className="h-[20rem] object-cover" alt="EDEN Hotel em Paris" />
        ...
        <div className="card-img relative">
          <img src={location2} className="h-[20rem] object-cover" alt="EDEN Hotel em Paris" />
        ...
        <div className="card-img relative">
          <img src={location3} className="h-[20rem] object-cover" alt="EDEN Hotel em Paris" />
        ...
        <div className="card-img relative">
          <img src={location4} className="h-[20rem] object-cover" alt="EDEN Hotel em Paris" />
        ...
        <div className="card-img relative">
          <img src={location5} className="h-[20rem] object-cover" alt="EDEN Hotel em Paris" />
        ...
        <div className="card-img relative">
          <img src={location6} className="h-[20rem] object-cover" alt="EDEN Hotel em Paris" />
